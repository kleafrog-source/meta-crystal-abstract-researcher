import { ZoomSlider } from "@/strudel-editor/components/zoom-slider";
import { Panel } from '@xyflow/react';
import { useState } from 'react';
import { NotebookText, Timer, Play, Pause, Menu, X } from 'lucide-react';
import { PatternPanel } from "@/strudel-editor/components/pattern-panel";
import { useGlobalPlayback } from "@/strudel-editor/hooks/use-global-playback";
import { CPM } from "@/strudel-editor/components/cpm";
import { ShareUrlPopover } from "@/strudel-editor/components/share-url-popover";
import { PresetPopover } from "@/strudel-editor/components/preset-popover";
import { AppInfoPopover } from "@/strudel-editor/components/app-info-popover";
